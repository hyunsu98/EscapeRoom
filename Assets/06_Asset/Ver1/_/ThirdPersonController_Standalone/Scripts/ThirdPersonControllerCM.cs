...
/*
 * Based on the Unity Starter Assets Third Person Controller
 * https://assetstore.unity.com/packages/essentials/starter-assets-third-person-character-controller-196526
 * */

namespace CodeMonkey.ThirdPersonController {

    public class ThirdPersonControllerCM : MonoBehaviour {
        ...
        private ThirdPersonControllerInput thirdPersonShooterInput;
        ...
        private void Awake() {
            ...
            thirdPersonShooterInput = GetComponent<ThirdPersonControllerInput>();
        ...
        private void CameraRotation() {
            ...
            Vector2 lookVector = thirdPersonShooterInput.GetLookVector();
            if (lookVector.sqrMagnitude >= threshold && !lockCameraPosition) {
        ...
        private void Move() {
            ...
            // update animator if using character
            if (hasAnimator) {
                animator.SetFloat(_animIDSpeed, animationBlend, .05f, Time.deltaTime);
